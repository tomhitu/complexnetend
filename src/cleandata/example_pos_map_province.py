...
if __name__ == '__main__':
    ...
    ''' -- clean city data -- '''
    # load non clean data from file and clean it
    merged_df = pd.merge(df_pos_with_state_clean, df_pos_with_state[['node', 'city']], on='node')
    df_pos_with_state_clean2  = clean_blank_city(merged_df)

    # save into csv
    df_pos_with_state_clean2.to_csv('df_pos_with_state_clean2.csv', index=False)
